  ...
  return (
    <div className="min-h-screen bg-background pt-32 pb-24">
      <div className="max-w-7xl mx-auto px-6">
        ...
        >
          <span className="text-apple-blue font-bold tracking-widest uppercase text-[10px] md:text-xs mb-6 block">Inventory & Showroom</span>
          <h1 className="text-5xl md:text-[80px] lg:text-[100px] font-bold tracking-tighter leading-none mb-8 text-black">
            The Collection.
          </h1>
          <p className="text-lg md:text-2xl text-gray-500 font-medium leading-snug">
        ...
        >
          <div className="flex items-center gap-3 text-muted w-full lg:w-auto lg:mr-4 border-b lg:border-b-0 border-white/10 pb-4 lg:pb-0">
            <Filter size={18} />
            <span className="text-xs uppercase tracking-widest font-bold mt-1">Sort & Filter</span>
          </div>
          ...
          <div className="flex flex-col sm:flex-row gap-6 md:gap-4 w-full lg:w-auto shrink-0 flex-1">
            <div className="relative group w-full sm:w-1/2 lg:max-w-[280px]">
              <select
                ...
                className="w-full appearance-none bg-surface border border-white/10 hover:border-white/30 rounded-2xl py-4 px-6 text-[11px] md:text-xs font-bold tracking-widest uppercase text-foreground focus:outline-none focus:ring-1 focus:ring-white/50 transition-all cursor-pointer shadow-sm mt-2 md:mt-0"
              >
                {makes.map((make) => (
              ...
              <span className="absolute -top-1 md:-top-2.5 left-5 bg-background px-2 text-[9px] uppercase tracking-widest text-[#86868b] font-bold pointer-events-none">Make</span>
            </div>
            ...
            <div className="relative group w-full sm:w-1/2 lg:max-w-[280px]">
              ...
              <ChevronDown className="absolute right-5 top-1/2 -translate-y-1/2 mt-1 md:mt-0 text-muted group-hover:text-foreground transition-colors pointer-events-none" size={16} />
              <span className="absolute -top-1 md:-top-2.5 left-5 bg-background px-2 text-[9px] uppercase tracking-widest text-[#86868b] font-bold pointer-events-none">Condition</span>
            </div>
          </div>
        </motion.div>
